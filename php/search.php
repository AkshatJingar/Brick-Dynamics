...
<head>
    ...
    <link rel="stylesheet" href="/Website3/css/search.css">
...
<body>
        ...
        <div class="post-grid">
            ...
            <div class="not_found">
                <div class="not_found_image">
                    <img class="not_found_img" src="/Website3/img/notfound.jpg">
                </div>
                <span class="not_found_span">Property You Searched For Is Not Available</span>
            </div>
            
            <?php
                    }
                function Post_display($row)
                    {
            ?>
                ...
                <div class="text-container"> 
                    ...
                    <div class="btns">
                        ...
                        <form action="wishlist.php" method="post">
                            <button type="submit" name="wishlist" value="<?php echo $row['p_id'] ?>" class="submit_btn">Add to Wishlist</button>
                        </form>
                        ...
                        <button type="button" class="submit_btn" onClick="togglePopup()">Add to Wishlist</button>
                        <button type="button" class="submit_btn" onClick="togglePopup()">Contact Owner</button>
    ...
    <div class="form" id="popup">
        ...
        <form id="form" method="post" action="/Website3/php/login_submit.php">
            <div class="close-btn" onClick="togglePopup()">&times;</div>
